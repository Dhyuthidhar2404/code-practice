    ...
    <div className="sticky top-0 z-50 bg-white shadow">
      <div className="container mx-auto flex justify-between items-center h-[70px] px-6">
        ...
        >
          ...
          <li>
            <a
              className={`font-medium cursor-pointer hover:text-primary transition-colors ${currentPage === "todo" ? "text-primary relative after:absolute after:left-0 after:bottom-0 after:w-full after:h-0.5 after:bg-primary" : "text-gray-700"}`}
